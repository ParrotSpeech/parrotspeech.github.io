 ...
 * @returns Boolean indicating if character is a sentence terminator
 */
 ...
 * @param c The character to test.
 * @returns Boolean indicating if character is a trailing character
 */
 ...
 * @returns Boolean indicating if token is an abbreviation
 */
...
export class TextSplitterStream {
    ...
    private _process(): void {
        ...
        const scanBoundary = (idx: number): BoundaryInfo => {
            let end = idx;
     ...
     * @returns AsyncGenerator that yields sentences
     */
     ...
     * @returns Iterator that yields sentences
     */
